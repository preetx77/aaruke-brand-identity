      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 md:gap-16 mb-12">
          ...
          <div className="space-y-4 text-center md:text-left">
            <span className="font-serif font-light text-[1.25rem] uppercase no-underline tracking-[0.15em]" 
          ...
          <div className="text-center md:text-left">
            <h4 className="font-sans text-sm tracking-[0.2em] uppercase text-[#c5a059] mb-4">Philosophy</h4>
          ...
          {/* Contact Section */}
          <div className="text-center md:text-left">
            <h4 className="font-sans text-sm tracking-[0.2em] uppercase text-[#c5a059] mb-4 ">Contact</h4>
            <button 
            
              onClick={onOpenContact} 
              className=" hover:text-white transition-colors text-sm font-light text-ivory/60 capitalize"
            >
              Send us an inquiry
            </button>
          </div>
          ...
          {/* Socials Section */}
          <div className="text-center md:text-left">
            <h4 className="font-sans text-sm tracking-[0.2em] uppercase text-[#c5a059] mb-4">Socials</h4>
